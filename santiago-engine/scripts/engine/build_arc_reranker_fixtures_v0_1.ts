...
const fixtures: FixtureDef[] = [
  ...
  { id: 'F8', label: '120 min D1 Flâneur', input: { traveler: F8_D1_FLANEUR_TRAVELER, startingStgoId: 'STGO_01', timeBudgetMin: 120, transportPolicy: 'WALK_ONLY', routeIntent: 'DISCOVERY' } },
