...
/**
 * Gate 2E.2E.1-R — F8 executable traveler is D1 Flâneur.
 *
 * `F_discovery_forward` stays D2 (Gate 2A / taxonomy "discovery-forward").
 * F8 only overrides posture. Interests, rhythm, budget, mobility unchanged.
 */
export const F8_D1_FLANEUR_TRAVELER: TravelerModel = {
  ...TRAVELER_FIXTURES.F_discovery_forward,
  discoveryPosture: 'D1',
}
