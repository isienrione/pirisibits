...
/**
 * Gate 2E.3-R — founder route inspection (Route Lab, read-only).
 * Does NOT enable production traveler routing.
 */
export const FOUNDER_ROUTE_INSPECTION_READY = true

/**
 * Gate 2E.3.1-R — scenario identity + reproducibility QA (Route Lab, read-only).
 * Does NOT enable production traveler routing or change engine scoring.
 */
export const SCENARIO_IDENTITY_QA_READY = true

/**
 * Gate 2E.3.2-R — route-time / insertion diagnostics (Route Lab, read-only).
 * Does NOT enable Experience-Time, VisitMode, or production routing.
 */
export const ROUTE_MODEL_DIAGNOSTICS_READY = true
