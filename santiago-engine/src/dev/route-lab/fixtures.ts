...
export const ROUTE_LAB_FIXTURES: RouteLabFixtureDef[] = [
  ...
  { id: 'F8', label: 'F8 — 120 min · D1 Flâneur', description: '120 min DISCOVERY (Flâneur posture fixture)', input: { traveler: F8_D1_FLANEUR_TRAVELER, startingStgoId: 'STGO_01', timeBudgetMin: 120, transportPolicy: 'WALK_ONLY', routeIntent: 'DISCOVERY' }, watchCase: true, watchNote: 'Reranking promoted a candidate that filled previously unused budget (Gate 2C left slack).' },
