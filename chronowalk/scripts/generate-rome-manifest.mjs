...
const manifest = {
  ...
  waypoints: {
    ...
    w17: wp('w17', {
      ...
      reconstruction: {
        ...
        then: '/rome/img/w13_then.avif',
        loop: '/rome/video/w13_then_loop.mp4',
      ...
      arrivalLine: 'Two thousand years of sky through one opening.',
    }),
    w18: wp('w18', {
      act: 'act5',
      zone: 'centro',
  ...
  transits: {
    ...
    t13: { after: 'w17', audio: 't13.mp3', zone: 'centro', duration_s: 30 },
