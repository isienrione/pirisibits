...
const geo = {
  ...
  w02: { lat: 41.8904, lng: 12.4924, radius_m: 40, name: 'Colosseum interior' },
  w03: { lat: 41.8905, lng: 12.48835, radius_m: 40, name: 'Arch of Titus' },
  w04: { lat: 41.8886, lng: 12.4872, radius_m: 50, name: 'The Palatine' },
  w06: { lat: 41.89175, lng: 12.488, radius_m: 40, name: 'Basilica of Maxentius' },
  ...
  w16: { lat: 41.90094, lng: 12.48331, radius_m: 35, name: 'Fontana di Trevi' },
  w17: { lat: 41.89885, lng: 12.47687, radius_m: 40, name: 'The Pantheon' },
  w23: { lat: 41.89868, lng: 12.47683, radius_m: 35, name: 'Pantheon interior' },
  w18: { lat: 41.89918, lng: 12.47306, radius_m: 45, name: 'Piazza Navona' },
  w19: { lat: 41.89559, lng: 12.47223, radius_m: 40, name: "Campo de' Fiori" },
...
function wp(id, extra = {}) {
  const g = geo[id]
  return {
    title: g.name,
    act: extra.act,
    geofence: { lat: g.lat, lng: g.lng, radius_m: g.radius_m },
    zone: extra.zone ?? 'antiquity',
    ...extra,
  }
}
...
const manifest = {
  ...
  reflections: [
    ...
    'Twenty centuries folded into one walk. You crossed them on foot.',
    'Some chapters remain ahead — Rome keeps a seat for your return.',
  ],
  acts: [
    ...
    { id: 'act4', numeral: 'IV', title: 'The Market', waypoints: ['w14'] },
    {
      id: 'act5',
      numeral: 'V',
  ...
  waypoints: {
    w01: wp('w01', {
      ...
      reconstruction: {
        now: '/rome/img/w01_now.avif',
        then: '/rome/img/w01_then.avif',
        loop: '/rome/video/w01_then_loop.mp4',
        caption: 'Evidence-based reconstruction · awning colours are informed conjecture',
      },
      approachLine: 'The amphitheatre rises ahead — slow your pace and look up.',
      arrivalLine: 'Take a second. / Look up.',
    }),
    w02: wp('w02', {
      act: 'act1',
      zone: 'antiquity',
      ...
      arrivalLine: 'You are standing where the crowd never stood.',
    }),
    w03: wp('w03', {
      act: 'act2',
      chapters: ['w03_ch1.mp3', 'w03_ch2.mp3'],
      outro_variants: { a: 'w03_outro_a.mp3', b: 'w03_outro_b.mp3' },
      inserts: ['ins_jerusalem'],
      reconstruction: {
        now: '/rome/img/w03_now.avif',
        then: '/rome/img/w03_then.avif',
        loop: '/rome/video/w03_then_loop.mp4',
        caption: 'Evidence-based reconstruction · relief details simplified for clarity',
      },
      approachLine: 'The Forum opens — Titus\' arch marks the threshold.',
      arrivalLine: 'Stand where triumph entered the city.',
    }),
    w04: wp('w04', {
      act: 'act2',
    ...
    w06: wp('w06', {
      act: 'act3',
      chapters: ['w06.mp3'],
      inserts: ['ins_constantine'],
      approachLine: 'Vaulted halls loom through the columns ahead.',
      arrivalLine: 'Imagine the roof still whole above you.',
    }),
    w07: wp('w07', {
      act: 'act3',
      chapters: ['w07.mp3'],
      inserts: ['ins_caesar_tease'],
      approachLine: 'You are walking the Sacred Way — keep to the stones.',
      arrivalLine: 'Processions passed here for a thousand years.',
    }),
    w08: wp('w08', {
      act: 'act3',
      chapters: ['w08.mp3'],
    ...
    pause: wp('pause', {
      ...
      chapters: ['pause.mp3'],
      scripted_rest: true,
      approachLine: 'Find shade. The Forum can wait.',
      arrivalLine: 'Nothing expires. Nothing is skipped forever.',
    }),
    w10: wp('w10', {
      act: 'act3',
      chapters: ['w10.mp3'],
      approachLine: 'The speakers\' platform is near — listen for echoes.',
      arrivalLine: 'Orators once held Rome from this spot.',
    }),
    w11_12: wp('w11_12', {
      act: 'act3',
      chapters: ['w11_12.mp3'],
      approachLine: 'The arch and the Senate house share one standpoint.',
      arrivalLine: 'Two stories, one square of stone.',
    }),
    w13: wp('w13', {
      act: 'act3',
      chapters: ['w13.mp3'],
    ...
    w17: wp('w17', {
      act: 'act5',
      zone: 'centro',
      chapters: ['w17_ch1.mp3'],
      reconstruction: {
        now: '/waypoints/pantheon/modern-poster.jpg',
        then: '/waypoints/pantheon/modern-poster.jpg',
        loop: '/waypoints/pantheon/ancient-reconstruction.mp4',
        caption: 'Evidence-based reconstruction · portico bronze finish is informed conjecture',
      },
      approachLine: 'The rotunda appears through the streets.',
      arrivalLine: 'The portico columns wait — step through when you are ready.',
    }),
    // Adjacent to exterior (Colosseum w01→w02 pattern): no transit between them.
    w23: wp('w23', {
      act: 'act5',
      zone: 'pantheon_interior',
      chapters: ['w17_ch2.mp3', 'w17_ch3.mp3', 'w17_ch4.mp3'],
      inserts: ['ins_agrippa'],
      photo: '/waypoints/pantheon/modern-poster.jpg',
      reconstruction: {
        now: '/waypoints/pantheon/modern-poster.jpg',
        then: '/waypoints/pantheon/modern-poster.jpg',
        loop: '/waypoints/pantheon/ancient-reconstruction.mp4',
        caption: 'Evidence-based reconstruction · temporary exterior stand-in until interior media ships',
      },
      approachLine: 'Step through the bronze doors — the floor you expect is not the sky above.',
      arrivalLine: 'Look straight up. The oculus is waiting.',
    }),
    w18: wp('w18', {
      act: 'act5',
      zone: 'centro',
    ...
    w21: wp('w21', {
      ...
      zone: 'river',
      chapters: ['w21.mp3'],
      alt_inserts: ['w21_alt_bruno'],
      approachLine: 'Hadrian\'s tomb rises beside the river.',
  ...
  transits: {
    t01: {
      after: 'w02',
      audio: 't01_shared.mp3',
      zone: 'antiquity',
      variants: { a: 't01_fork_a.mp3', b: 't01_fork_b.mp3' },
      choice: true,
      duration_s: 70,
    },
    t02: { after: 'w04', audio: 't02.mp3', zone: 'antiquity', duration_s: 25 },
    t05: { after: 'w06', audio: 't05.mp3', zone: 'antiquity', duration_s: 30 },
    t06: { after: 'w07', audio: 't06.mp3', zone: 'antiquity', duration_s: 25 },
    t07: { after: 'w08', audio: 't07.mp3', zone: 'antiquity', duration_s: 35 },
    t08: { after: 'w10', audio: 't08.mp3', zone: 'antiquity', duration_s: 15 },
    t09: { after: 'w11_12', audio: 't09.mp3', zone: 'antiquity', duration_s: 25 },
    t10: { after: 'w13', audio: 't10.mp3', zone: 'antiquity', duration_s: 30 },
    t14: { after: 'w14', audio: 't14.mp3', zone: 'centro', duration_s: 600 },
    t15: { after: 'w15', audio: 't15.mp3', zone: 'centro', duration_s: 30 },
    t12: { after: 'w16', audio: 't12.mp3', zone: 'centro', duration_s: 30 },
    t13: { after: 'w23', audio: 't13.mp3', zone: 'centro', duration_s: 30 },
    t18: { after: 'w18', audio: 't18.mp3', zone: 'centro', duration_s: 25 },
    t19: {
      after: 'w19',
      audio: 't19.mp3',
      zone: 'centro',
    ...
    t03: {
      after: 'w04',
      zone: 'antiquity',
      variants: { a: 't03_a.mp3', b: 't03_b.mp3' },
      duration_s: 30,
    },
  },
  inserts: {
    ins_whopaid: { audio: 'ins_whopaid.mp3', requires: ['w01'] },
    ins_window: { audio: 'ins_window.mp3', requires: ['w04'] },
    ins_jerusalem: { audio: 'ins_jerusalem.mp3', requires: ['w01'] },
    ins_fire: { audio: 'ins_fire.mp3', requires: ['w08'] },
    ins_caesar_tease: { audio: 'ins_caesar_tease.mp3', requiresAny: ['w07', 'w11_12'] },
    ins_water_trevi: { audio: 'ins_water_trevi.mp3', requires: ['w15'] },
    ins_agrippa: { audio: 'ins_agrippa.mp3', requires: ['w16'] },
    ins_constantine: { audio: 'ins_constantine.mp3', requiresHeard: ['t01'] },
    w21_alt_bruno: { audio: 'w21_alt_bruno.mp3', playIfMissing: ['w19'] },
  },
  beds: {
    antiquity: 'bed_antiquity.mp3',
    centro: 'bed_centro.mp3',
    river: 'bed_river.mp3',
    underworld: 'bed_underworld.mp3',
    pantheon_interior: 'bed_pantheon_interior.mp3',
  },
  system: {
    presence: 'sfx_presence.mp3',
    longwalk: 't_longwalk.mp3',
    no_ticket: ['alt_forum_1.mp3', 'alt_forum_2.mp3'],
    ui: {
      arrival: 'ui_arrival_chime.mp3',
      threshold: 'ui_threshold_tone.mp3',
