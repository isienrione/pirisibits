 ...
 * or inside the Capacitor native shell (already the installed app).
 */
...
/** True when PWA / Add to Home Screen UI should be offered. */
export function shouldOfferPwaInstall() {
  return canOfferPwaInstall() && !isStandaloneMode()
}
