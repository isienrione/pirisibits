...
describe('LegalMarkdown', () => {
  it('preserves bracket placeholders and LEGAL NAME in Terms', () => {
    render(<LegalMarkdown source={termsSource} />)
    expect(screen.getByRole('heading', { name: /terms of service/i })).toBeInTheDocument()
    expect(
      screen.getByText(/\[LEGAL NAME — e\.g\. your full legal name as sole proprietor/i),
    ).toBeInTheDocument()
    expect(screen.getAllByText('[support@chronowalk.com]').length).toBeGreaterThan(0)
