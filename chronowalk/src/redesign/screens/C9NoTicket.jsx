  ...
  return (
    <div className="cw-grain" style={{ background: T.bone, height: "100%", fontFamily: F.body, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ padding: "52px 24px 0", flexShrink: 0, position: "relative", zIndex: 2 }}>
        ...
        <div style={{ width: "100%", height: 1, background: `${withAlpha(T.muted, '28')}`, marginBottom: 28 }} />
      </div>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ marginTop: 14 }}>
            ...
            <div style={{
              ...
              border: `1px solid ${withAlpha(T.muted, '30')}`,
              ...
              <svg width="100%" height="90" viewBox="0 0 310 90">
                ...
                <rect x="0" y="36" width="310" height="18" rx="3" fill={`${withAlpha(T.muted, '18')}`} />
            ...
            {onDismiss ? (
              <button
                ...
                style={{
                  ...
                  fontFamily: F.body,
                  fontSize: 14,
                  border: `1px solid ${withAlpha(T.muted, '40')}`,
                  cursor: "pointer",
                }}
              >
