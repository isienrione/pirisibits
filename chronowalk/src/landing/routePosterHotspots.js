 ...
 * Sticker 5 (Roman Forum General View) has no tour stop — omitted.
 * Stickers 11–12 (Severus + Curia) share combined stop w11_12.
 */

/** @typedef {{ id: string, waypointId: string, label: string, left: number, top: number, width: number, height: number }} RoutePosterHotspot */
...
export const ROMA_ETERNA_ROUTE_HOTSPOTS = [
  ...
  { id: 'art-3', waypointId: 'w04', label: 'Palatine Hill Terrace', left: 46.5, top: 12.8, width: 11, height: 6.2 },
  { id: 'art-4', waypointId: 'enc_circus', label: 'Circus Maximus View', left: 46, top: 22.5, width: 11.5, height: 6.2 },
  ...
  { id: 'art-11', waypointId: 'w11_12', label: 'Arch of Septimius Severus', left: 72.5, top: 55.5, width: 12, height: 6.2 },
  { id: 'art-12', waypointId: 'w11_12', label: 'Curia Julia', left: 73.5, top: 68, width: 11.5, height: 6.2 },
