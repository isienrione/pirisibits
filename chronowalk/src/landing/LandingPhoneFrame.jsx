 ...
 */
export default function LandingPhoneFrame({ label, children, size = 'md', className = '' }) {
  return (
    <div className={`cw-landing-phone cw-landing-phone--${size}${className ? ` ${className}` : ''}`} aria-label={label}>
