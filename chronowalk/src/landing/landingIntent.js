...
export const LANDING_INTENT_VARIANTS = Object.freeze({
  rome: Object.freeze({
    ...
    previewCtaAriaLabel: 'Try the complete Pantheon stop free',
    ctaPriority: 'unlock',
  ...
  colosseum: Object.freeze({
    ...
    unlockCta: UNLOCK_PRICED,
    previewCta: 'Try a complete stop free',
    previewCtaAriaLabel: 'Try a complete stop free',
    ctaPriority: 'unlock',
  ...
  pantheon: Object.freeze({
    ...
    previewCtaAriaLabel: 'Try the Pantheon stop free',
    ctaPriority: 'preview',
