...
function RouteLine({ meander }) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="lab-letter-spectrum" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <path
        ...
        d={meander.path}
        fill="none"
        stroke="url(#lab-letter-spectrum)"
        strokeWidth="2.5"
        strokeLinecap="round"
...
export default function JourneyLetter({
  ...
  return (
    <div
      className="min-h-[28rem] w-full bg-obsidian px-6 py-10 text-warmwhite"
