...
export const ES_LANDING = Object.freeze({
  ...
  LANDING_CONTENT: {
    ...
    header: {
      ...
      exploreNav: [
        { id: 'top', label: 'Volver arriba', href: '#top' },
        { id: 'hero-reassurance', label: 'Por qué es fácil', href: '#hero-reassurance' },
        { id: 'monuments', label: 'Paradas del recorrido', href: '#monuments' },
        { id: 'how-it-works', label: 'Cómo funciona un paseo', href: '#how-it-works' },
        { id: 'who-its-for', label: 'Si cambia el plan', href: '#who-its-for' },
        { id: 'pricing', label: 'Elige tu recorrido', href: '#pricing' },
        { id: 'get-app', label: 'Empieza en el navegador', href: '#get-app' },
        { id: 'faq', label: 'Antes de comprar', href: '#faq' },
      ],
    },
    footer: {
      tagline:
